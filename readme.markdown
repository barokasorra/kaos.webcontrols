...
* Bug no ExpandedCheckBox que ao setarmos EnableClientScript para false não funciona corretamente. Não afeta em nada o funcionamento correto do compomente quando setado para true.

...
//	email :	fuushikaden@yahoo.com
	...
	var gotoString = "Vai para o m&ecirc;s atual"
	var todayString = "Hoje &eacute;"
	var weekString = "Sem."
	var scrollLeftMessage = "Clique aqui para ir para o m&ecirc;s anterior."
	var scrollRightMessage = "Clique aqui para ir para o pr&oacute;ximo m&ecirc;s."
	var selectMonthMessage = "Clique aqui para selecionar o m&ecirc;s."
	var selectYearMessage = "Clique aqui para selecionar o ano."
    ...
    */
	...
	if (dom)
	{
		...
		document.write ("<div onclick='bShow=true' id='calendar'	style='z-index:+999;position:absolute;visibility:hidden;'><table	width="+((showWeekNumber==1)?250:220)+" style='font-family:arial;font-size:11px;border-width:1;border-style:solid;border-color:#a0a0a0;font-family:arial; font-size:11px}' bgcolor='#ffffff'><tr bgcolor='#0000aa'><td><table width='"+((showWeekNumber==1)?248:218)+"'><tr><td style='padding:2px;font-family:arial; font-size:11px;'><font color='#ffffff'><B><span id='caption'></span></B></font></td><td align=right><a href='javascript:hideCalendar()'><IMG SRC='"+imgDir+"close.gif' WIDTH='15' HEIGHT='13' BORDER='0' ALT='Fechar calend&aacute;rio'></a></td></tr></table></td></tr><tr><td style='padding:5px' bgcolor=#ffffff><span id='content'></span></td></tr>")
	...
	var	monthName2 = new Array("JAN","FEB","MAR","ABR","MAI","JUN","JUL","AGO","SET","OUT","NOV","DEZ")
	if (startAt==0)
	{
	...
	{
		dayName = new Array	("Seg","Ter","Qua","Qui","Sex","S&aacute;b","Dom")
	}

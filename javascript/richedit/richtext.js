...
function writeRichText(rte, html, width, height, buttons, readOnly) {
	if (isRichText) {
		...
		if (buttons == true) {
			...
			document.writeln('	<tr>');
			document.writeln('		<td>');
			document.writeln('			<select class="rteCombo" id="formatblock_' + rte + '" onchange="selectFont(\'' + rte + '\', this.id);">');
			...
			document.writeln('		</td>');
			document.writeln('		<td>');
			document.writeln('			<select class="rteCombo" id="fontname_' + rte + '" onchange="selectFont(\'' + rte + '\', this.id)">');
			...
			document.writeln('		</td>');
			document.writeln('		<td>');
			document.writeln('			<select class="rteCombo "unselectable="on" id="fontsize_' + rte + '" onchange="selectFont(\'' + rte + '\', this.id);">');

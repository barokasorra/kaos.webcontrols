...
function MoneyUtil(fld, milSep, decSep, e) {
var sep = 0;
var key = '';
var i = j = 0;
var len = len2 = 0;
...
aux += key;len = aux.length;if (len == 0) fld.value = '';
//if (len == 1) fld.value = '0'+ decSep + '0' + aux;if (len == 2) fld.value = '0'+ decSep + aux;
if (len ==1) fld.value = aux + decSep + '0' + '0';if (len ==2) fld.value = aux + decSep + '0';
if (len > 2) 
{
aux2 = '';
